...
fig1a <- test_reduction_only %>% mutate(test_reduction = as.factor(test_reduction)) %>% 
  ...
  scale_fill_brewer("General\nHTS\nreduction", labels = c("None\n(Status quo)", "25%", "50%", "75%", "100%"), aesthetics = c("colour", "fill"), palette = "Set1") + 
...
test_reduction_reduced <- test_reduction_update %>% 
  ...
  pivot_wider() %>% 
  mutate(test_reduction = 100 - test_reduction)

fig1_extra1 <- test_reduction_reduced %>% 
  filter(indicator %in% c("pos_tests_per_adult"),
         year >= 2020,
         test_reduction %in% c(0, 25, 50, 75, 100)) %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        aspect.ratio=1, 
        legend.title = element_text(size = 11)) +
  scale_y_continuous("Positive HIV tests per 100", labels =(function(l) {round(l*1e2,1)}),expand = c(0, 0)) +
  scale_fill_brewer("General\nHTS\nreduction", labels = c("None\n(Status quo)", "25%", "50%", "75%", "100%"), aesthetics = c("colour", "fill"), palette = "Set1") + 
  ggtitle("Positive HIV tests\n(per 100; 15+ years)")
fig1_extra1

fig1_extra2 <- test_reduction_reduced %>% filter(indicator %in% c(
                          "test_positiviy"), year >=2020,
         test_reduction %in% c(0, 25, 50, 75, 100)) %>% 
  mutate(test_reduction = as.factor(test_reduction)) %>% 
   ggplot(aes(year, mean, group = test_reduction)) +
  geom_ribbon(aes(ymin = lower_CI, ymax = upper_CI, fill = test_reduction), alpha = 0.10, show.legend = F) +
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        aspect.ratio=1, 
        legend.title = element_text(size = 11)) +
  scale_y_continuous("HIV test positivity", labels =(function(l) {paste0(round(l*1e2,1),"%")}),expand = c(0, 0)) +
  scale_fill_brewer("General\nHTS\nreduction", labels = c("None\n(Status quo)", "25%", "50%", "75%", "100%"), aesthetics = c("colour", "fill"), palette = "Set1") + 
...
fig1 <- ggarrange(fig1a, fig1b, fig1c, fig1d, fig1_extra1,fig1_extra2, nrow = 3, ncol = 2, common.legend = TRUE, legend = "right", labels = "AUTO", font.label = list(size = 14))
ggsave(filename = "figures/Figure_1.pdf", plot = fig1, device = "pdf", height =20, units = "cm")
ggsave(filename = "figures/fig1.png", plot = fig1, device = "png", height =20, units = "cm")
fig1
```
...
```{r fig1e, echo=FALSE}
fig1e <- cost_summary %>% mutate(test_reduction = as.factor(test_reduction)) %>% 
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
...
```{r fig1f, echo=FALSE}
fig1f <- cost_summary %>% mutate(test_reduction = as.factor(test_reduction)) %>% 
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
...
```{r fig1g, echo=FALSE}
fig1g<- cost_summary %>% mutate(test_reduction = as.factor(test_reduction)) %>% 
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
...
```{r fig1h, echo=FALSE}
fig1h<- cost_summary %>% mutate(test_reduction = as.factor(test_reduction)) %>% 
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
...
```{r fig2_costs, echo = FALSE}
# read dataframes
cost_summary <- read_csv("~/Documents/clean_results/cost_summary.csv")
cumulative_change_from_baseline_total <- read_csv("~/Documents/clean_results/cumulative_change_from_baseline_total.csv")
...
fig2a
ggsave(filename = "figures/fig2a.png", plot = fig2a, device = "png", units = "cm", width = 11.69, height = 10.41)
```
...
fig2b
ggsave(filename = "figures/fig2b.png", plot = fig2b, device = "png", units = "cm", width = 11.69, height = 10.41)
```
...
fig2c
ggsave(filename = "figures/fig2c.png", plot = fig2c, device = "png", units = "cm", width = 11.69, height = 10.41)
```
...
## Supplementary key pop fig

```{r supp keypop, echo=FALSE}
...
prop_new_inf_kp <- baseline_1000 %>% 
  ...
  scale_fill_brewer("Key population", aesthetics = c("colour", "fill"), 
                    labels = c("FSW", "Clients of FSW", "MSM"), 
                    palette = "Set1") + 
  ggtitle("Contribution to new HIV infections\nby key populations")
...
baseline_1000 %>% 
  ...
  scale_fill_brewer("General\nHTS\nreduction", labels = c("Status quo", "25%", "50%", "75%", "100%"), aesthetics = c("colour", "fill"), palette = "Set1") + 
  ggtitle("HIV incidence \n(per 1000; MSM)") 
...
incidence_kp <- baseline_1000 %>% 
  ...
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
         indicator %in% c("HIVincFSW","HIVincMSM"),
         year >= 2020, 
         test_reduction %in% c(0, 25, 50, 75, 100)) %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        legend.title = element_text(size = 11)) +
  scale_y_continuous("HIV incidence per 1000", labels =(function(l) {round(l*1e3,1)}),expand = c(0, 0)) +
  scale_fill_brewer("Key population", labels = c("FSW", "MSM"), aesthetics = c("colour", "fill"), palette = "Set1") + 
...
art_coverage_kp <- baseline_1000 %>% 
  ...
  filter(scenario == "intervention", 
         pitc_reduction_year == 2025, 
         indicator %in% c("ARTcoverageMSM","ARTcoverageFSW"),
         year >= 2020, 
         test_reduction %in% c(0, 25, 50, 75, 100)) %>% 
  ggplot(aes(year, mean, group = indicator, fill = indicator)) +
  geom_ribbon(aes(ymin = lower_CI, ymax = upper_CI, fill = indicator), alpha = 0.10, show.legend = F) +
...
key_pop_fig <- ggarrange(incidence_kp, art_coverage_kp, prop_new_inf_kp, nrow = 1, ncol = 3, labels = c("A", "B", "C"), label.args = list(gp = grid::gpar(fontface = "bold", fontsize = 14)))

ggsave(filename = "figures/fig_S13.png", plot = key_pop_fig, device = "png", width = 20, units = "cm")
ggsave(filename = "figures/fig_S13.pdf", plot = key_pop_fig, device = "pdf", width = 20, units = "cm")
...
prop_new_inf_kp <- baseline_1000 %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        legend.position = "right") +
  scale_y_continuous("Proportion of total\nnew HIV infections (%)",expand = c(0, 0), labels =(function(l) {round(l*1e2,2)}), limits = c(0,0.31)) +
  scale_fill_manual("Population", aesthetics = c("colour", "fill"), breaks = c("Prop_NewHIV_client", "Prop_NewHIV_FSW", "Prop_NewHIV_MSM"), values = c("Prop_NewHIV_client" = "#4daf4a", "Prop_NewHIV_FSW" = "#e41a1c", "Prop_NewHIV_MSM" = "#377eb8"), 
...
incidence_kp <- baseline_1000 %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        legend.title = element_text(size = 11)) +
  scale_y_continuous("HIV incidence per 1000", labels =(function(l) {round(l*1e3,1)}),expand = c(0, 0)) +
  scale_fill_manual("Population", aesthetics = c("colour", "fill"), breaks = c("HIVinc15to49","HIVincFSW","HIVincMSM"), values = c("HIVinc15to49" = "black", "HIVincFSW" = "#e41a1c", "HIVincMSM" = "#377eb8"), 
                    labels= c("Adults (15-49 years)", "FSW", "MSM")) + 
  ggtitle("HIV incidence \n(per 1000; Key populations)")
...
prev_kp <- baseline_1000 %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        legend.title = element_text(size = 11)) +
  scale_y_continuous("HIV prevalence (%)", labels =(function(l) {round(l*1e2,1)}), expand = c(0,0)) +
  scale_fill_manual("Population", aesthetics = c("colour", "fill"), breaks = c("Prev15to49","PrevFSW", "MSMprev18plus"), 
                    values = c("Prev15to49" = "black", "PrevFSW" = "#e41a1c", "MSMprev18plus" = "#377eb8"), 
                    labels= c("Adults (15-49 years)", "FSW", "MSM")) + 
  ggtitle("HIV prevalence\n(Key populations)")
...
art_coverage_kp <- baseline_1000 %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        legend.title = element_text(size = 11)) +
  scale_y_continuous("ART coverage (%) ", labels =(function(l) {round(l*1e2,1)}), limits = c(0,1), expand = c(0,0)) +
  scale_fill_manual("Population", aesthetics = c("colour", "fill"), 
                    breaks = c("ARTcoverageAdult","ARTcoverageFSW", "ARTcoverageMSM"), 
                    values = c("ARTcoverageAdult" = "black", "ARTcoverageFSW" = "#e41a1c", "ARTcoverageMSM" = "#377eb8"), 
                    labels= c("Adults (15+ years)", "FSW", "MSM")) + 
  ggtitle("ART coverage\n(Key populations)")
...
ggsave(filename = "figures/fig_S13.png", plot = key_pop_fig, device = "png", width = 23, height = 13, units = "cm")
ggsave(filename = "figures/fig_S13.pdf", plot = key_pop_fig, device = "pdf", width = 23, height = 13, units = "cm")
detach("package:egg", unload = TRUE)
