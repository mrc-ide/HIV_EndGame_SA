...
suppfig11 <- art_needs_costs %>% 
  ...
  theme(axis.text = element_text(size = 11), 
        ...
        aspect.ratio=1, 
        legend.title = element_text(size = 11)) +
  scale_y_continuous("Adults on ART (millions)", labels =(function(l) {paste(round(l/1e6,1))}),expand = c(0, 0)) +
  scale_fill_brewer(name = "General\nHTS\nreduction", 
                    labels= c("None", "25%", "50%", "75%", "100%"), palette = "Set1", aesthetics = c("colour", "fill")) + 
  ggtitle("Adults on ART\n(millions; 15+ years)")
ggsave(plot = suppfig11, filename = "figures/suppfig11.png", device = "png", units = "cm", height = 14, width = 16)
ggsave(plot = suppfig11, filename = "figures/suppfig11.pdf", device = "pdf", units = "cm", height = 14, width = 16)
