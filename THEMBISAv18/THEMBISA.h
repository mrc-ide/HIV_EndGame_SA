...
PostOutputArray TotalDiagPregAnnualChange(116);
PostOutputArray NewDiagPregAnnualChange(116);
PostOutputArray TestPosANCAnnualChange(116);
...
PostOutputArray TotalDiagNotOnART(116);
...
PostOutputArray HIVPosTestAnnualChange(116);
PostOutputArray AdultTestPosAnnualChange(116);
PostOutputArray Adult1stPosAnnualChange(116);
